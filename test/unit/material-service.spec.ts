...
import { FileDatabaseClient } from '../../src/app/client/file-database-client';
...
describe('Material service', () => {
    ...
    it('should get materials from the database', async () => {
        ...
        sandbox.stub(FileDatabaseClient.prototype, 'getMaterials').resolves(mockedMaterialsFromDatabase);
